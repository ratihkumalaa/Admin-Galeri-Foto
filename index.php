        ...
        <section class="header-section">
            <div class="container">
                ...
                <section class="hero-section">
                    <p class="judul">Galeri Karya Saya!</p>
                    <p 
                    style="
                        font-family: 'Helvetica', serif;
                        ">Jangan ragu untuk mengeksplorasi,karena ada begitu banyak hal menarik, unik, dan mengesankan yang bisa Anda temukan di sini. Semoga karya-karya ini menginspirasi Anda!</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="card">                            
                            ...
                            <a href="detail.php?FotoID=<?php echo urlencode($row['FotoID']); ?>">
                                <img src="admin/<?php echo $image_url; ?>" class="icon-why-us rounded-top" style="width:270px" alt="Gambar Gallery">
                            </a>
        ...
        <div class="owl-carousel">
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $formatted_date = date('d M Y', strtotime($TanggalKomentar));
            ?>
                    <div class="item">
                        <div class="testi-box">
                            <div class="row">
                                <div class="col-lg-3 vh-center py-4">
                                    ...
                                    <img src="admin/<?php echo $image_url; ?>" alt="person image" class="rounded-circle" style="width: 80px; height: 80px; object-fit: cover;">
                                </div>
                                <div class="col-lg-9">
            ...
            <?php
                ...
                echo "<p class='text-center'>Tidak ada komentar ditemukan.</p>";
            }
            ?>
        </div>
    </section>
