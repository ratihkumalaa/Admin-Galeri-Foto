...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="hal_admin.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Admin Galeri</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseGallery" class="collapse" aria-labelledby="headingGallery" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Galeri</h6>
                        <a class="collapse-item" href="galery.php">Tambah Gambar</a>
                        <a class="collapse-item" href="tampilan.php">Tampil Gambar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseKategori" class="collapse" aria-labelledby="headingKategori" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="kategori.php">Tambah Kategori</a>
                        <a class="collapse-item" href="tampilan-kategori.php">Lihat Kategori</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Komentar -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseKomentar"
                    aria-expanded="true" aria-controls="collapseKomentar">
                ...
                <div id="collapseKomentar" class="collapse" aria-labelledby="headingKomentar" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tampil-komentar.php">Lihat Komentar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tampil-user.php">Daftar User</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="hal_admin.php" data-toggle="modal" data-target="#logoutModal">
